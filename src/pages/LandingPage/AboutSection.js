...
const Hero = () => (
    <section className="hero-section py-5 py-md-5">
        <div className="container text-center py-5">
            ...
            <p className="lead text-secondary mx-auto mb-5" style={{ maxWidth: '48rem' }}>
...
const ContentCard = ({ title, body, icon, borderColor }) => (
    ...
    <div className="card h-100 shadow-sm border-0" style={{ borderTop: `4px solid ${borderColor}`, borderRadius: '0.5rem', transition: 'all 0.3s ease-in-out' }}>
      <div className="card-body">
        ...
        {/* FONT SIZE CHANGE: Changed p class to include a smaller size (text-small is not standard bootstrap, using standard size for smaller look) */}
        <p className="card-text text-muted small">{body}</p>
      </div>
    </div>
);
